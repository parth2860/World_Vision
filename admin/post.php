...
include 'conn.php';
  ...
  $image = $_FILES['image']['name'];
  	// Get text
  	$content = mysqli_real_escape_string($db, $_POST['text']);
  ...
  //	$isql = "INSERT INTO post (title, con , cat, image) VALUES ('$title', '$image_text', '$cat', '$text')";
    $isql = "INSERT INTO post ( `title`, `content`, `category`, `image`,`username`,`user_id`) VALUES ('$title', '$content', '$cat', '$image','$username','$userid')";
  	// execute query
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa fa-bars"></i> POST</h3>
            <ol class="breadcrumb">
                  ...
                  <div class="form quick-post">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="form-horizontal">
                      ...
                      <?php
                            ...
                            $re = mysqli_query($db, "SELECT * FROM `category_mst` ");
                      ...
                      <!-- Tags -->
                      <div class="form-group">
                        <label class="control-label col-lg-2" for="tags">Upload here</label>
                        <div class="col-lg-10">
