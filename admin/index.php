...
/*
  ...
  if (isset($_POST['upload'])) {
  	...
  	// Get text
  	$image_text = mysqli_real_escape_string($db, $_POST['con']);
    ...
    $cat= $_POST['cat'];
  	...
  	$target = "post/".basename($image);

  	$sql = "INSERT INTO post (title, con , cat, image) VALUES ('$title', '$image_text', '$cat', '$image')";
  	// execute query
  	mysqli_query($db, $sql);
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
       ...
       <?php
      $s="SELECT id FROM `users` ORDER BY id";
      $r=mysqli_query($db, $s);
      $row=mysqli_num_rows($r);
       ?>
        ...
        <div class="row">
          ...
          <?php
      $s="SELECT id FROM `post` ORDER BY id";
      $r=mysqli_query($db, $s);
      $row=mysqli_num_rows($r);
       ?>
          ...
          <!--/.col-->
          <?php
      $s="SELECT id FROM `group_mst` ORDER BY id";
      $r=mysqli_query($db, $s);
      $row=mysqli_num_rows($r);
       ?>
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
          ...
          <!--/.col-->
          <?php
      $s="SELECT id FROM `headline` ORDER BY id";
      $r=mysqli_query($db, $s);
      $row=mysqli_num_rows($r);
       ?>
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box green-bg">
              <i class="fa fa-cubes"></i>
              <div class="count"><?php  echo $row; ?></div>
              <div class="title">total headline</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
