...
$sql="SELECT * FROM post where id='$user'  ";
$result = mysqli_query($con, $sql);
$data = mysqli_fetch_assoc($result);

if(isset($_POST['update'])){
  $q = "UPDATE `post` SET `title`='$_POST[title]',`content`='$_POST[con]',`category`='$_POST[cat]' WHERE id='$user'";
            ...
            <form method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row">
                                  <div class="col-sm-12">
                                    <div class="form-group">
                                    <h3>text </h3>
                                    <textarea    class="form-control" name="con" ><?php  echo $data['content']?></textarea>
                                    </div>
                                  </div>
                                </div>
                                <?php
                                ...
                                <div class="row">
                                  <div class="col-sm-12">
                                    ...
                                    <select class="form-control" name="cat">
                                                              <option value="<?php  echo $data['category']?>">current category:<?php  echo $data['category']?></option>
                                                              <?php
