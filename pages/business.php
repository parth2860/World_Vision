  ...
  <body>
    <div class="container-scroller">
     ...
     <div    id="WORLD Post" class="tabcontent" >
          <img  src="../assets/images/travel/WhatsApp Image 2021-05-27 at 1.38.51 PM.jpeg" height="200"  width="1100"  >
          ...
          <div class="row" >
            <div class="col-sm-12">
              <div class="d-flex position-relative  float-left">
                <h3 class="section-title">Games News</h3>
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <?php 
           $sql = "SELECT * FROM `post` WHERE `category` = 'games' AND `status` = 1 and `image` NOT LIKE '%mp4' order by id DESC  limit 4";
         ...
         <!--grid end -->
                  ...
                  $results_per_page = 5;
                  $result = mysqli_query($con,"SELECT * FROM `post` WHERE `category` = 'games' AND `status` = 1 and `image` NOT LIKE '%mp4' order by id DESC");
                  ...
                  $number_of_pages = ceil($number_of_results/$results_per_page);
                      ...
                      if($result->num_rows > 0){
                        ...
                        $re = mysqli_query($con ,"SELECT * FROM `post` WHERE `category` = 'games' AND `status` = 1 and `image` NOT LIKE '%mp4' order by id DESC LIMIT $this_page_first_result,$results_per_page ");
                ...
                <table  align="justify">
                <tr >
                <td >   <img width=500 height=300  src="../admin/post/'.$row['image'].' "  disable  >  </td>
              ...
              ';
                ...
                for($page=1;$page<=$number_of_pages;$page++){
                  echo '
                  <tr>
                      <td align=center> <a href="business.php?page='.$page.'">' .$page. '</a>  ';
                  echo '
                  </td>
                  </tr>';
                }
