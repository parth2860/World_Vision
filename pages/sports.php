  ...
  <body>
    <div class="container-scroller">
     ...
     <div    id="WORLD Post" class="tabcontent" >
          <img  src="../assets/images/travel/WhatsApp Image 2021-05-27 at 1.38.46 PM.jpeg" height="200"  width="1100"  >
          ...
          <?php 
           $sql = "SELECT * FROM `post` WHERE `category` = 'sports' AND `status` = 1  and `image` NOT LIKE '%mp4' order by id DESC  limit 4";
         ...
         <!--grid end -->
               ...
               $results_per_page = 5;
               $result = mysqli_query($con,"SELECT * FROM `post` WHERE `category` = 'sports' AND `status` = 1  and `image` NOT LIKE '%mp4' order by id DESC");
               ...
               $number_of_pages = ceil($number_of_results/$results_per_page);
                   ...
                   if($result->num_rows > 0){
                    ...
                    $re = mysqli_query($con ,"SELECT * FROM `post` WHERE `category` = 'sports' AND `status` = 1 and `image` NOT LIKE '%mp4' order by id DESC LIMIT $this_page_first_result,$results_per_page ");
              ...
              ';
                ...
                for($page=1;$page<=$number_of_pages;$page++){
                  echo '
                  <tr>
                      <td align=center> <a href="sports.php?page='.$page.'">' .$page. '</a>  ';
                  echo '
                  </td>
                  </tr>';
                }
