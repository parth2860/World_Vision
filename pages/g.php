    ...
    <div class="container-scroller">
      ...
      <div class="container">
        <div class="main-body">
         ...
         <!--start -->
         <div id="" class="">
                  <div align="center"><h3>page</h3></div>
                  <?php
                  $a=$_GET['id'];
                  ...
                  <div class="card social-timeline-card overflow mb-3"  style=" border: 2px solid #b3afaf;  border-radius: 12px">
                      <div class="card-header " style="background-color:#cfc9c8;">
                      ...
                      <h4><div align="center" style="background-color:#dbd9d9;" ><?php echo $row['text']; ?></div></h4>
                    </div>
                                        <!--form start -->
                                        <div class="panel-group m-bot20" id="accordion" style="background-color:#dbd9d9;">
                                                                    ...
                                                                    <form method="POST" enctype="multipart/form-data" class="form-horizontal">
                                                                      <div class="row">
                                                                        <div class="col-sm-6">
                                                                          ...
                                                                          <b>Post Title</b> <input type="text" name="title" class="form-control" placeholder="Enter post Title" required/> 
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                      <div class="row">
                                                                        <div class="col-sm-6">
                                                                          <div class="form-group">
                                                                          <b>Post Description</b>  <textarea class="form-control" name="con" placeholder="Enter post Content" required></textarea>
                                                                          </div>
                                                                        </div>
                                                                      </div>
                     ...
                     $b=$_GET['name'];
                    // $username = $data['username'];
                     $usql = "SELECT * FROM group1 where gname='$b'   and `image` NOT LIKE '%mp4' and `status`=1 order by id DESC";
                  ...
                  ?>
                     ...
                     $b=$_GET['name'];
                    // $username = $data['username'];
                     $usql = "SELECT * FROM group1 where gname='$b'   and `image`  LIKE '%mp4' and `status`=1 order by id DESC";
                     //$usql = "SELECT * FROM group1    ";
                  $r3 = $con->query($usql);
                  if($r3->num_rows > 0) {
                    while($rw = $r3->fetch_assoc()){
