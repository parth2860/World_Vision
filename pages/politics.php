  ...
  <body>
    <div class="container-scroller">
     ...
     <div    id="WORLD Post" class="tabcontent" >
          <img  src="../assets/images/travel/politics.jpg" height="200"  width="1100"  >
          ...
          <div class="row" >
            <div class="col-sm-12">
              <div class="d-flex position-relative  float-left">
                <h3 class="section-title">Politics News</h3>
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <?php 
           $sql = "SELECT * FROM `post` WHERE `category` = 'politics/regional' AND `status` = 1 and `image` NOT LIKE '%mp4' order by id DESC  limit 4";
         ...
         <!--grid end --> 
                    <?php
                      ...
                      $results_per_page = 5;
                      $result = mysqli_query($con,"SELECT * FROM `post` WHERE `category` = 'politics/regional' AND `status` = 1 and `image` NOT LIKE '%mp4' order by id DESC ");
                      ...
                      if($result->num_rows > 0){
                        ...
                        $re = mysqli_query($con ,"SELECT * FROM `post` WHERE `category` = 'politics/regional' AND `status` = 1 and `image` NOT LIKE '%mp4' order by id DESC LIMIT $this_page_first_result,$results_per_page ");
              ...
              ';
                ...
                for($page=1;$page<=$number_of_pages;$page++){
                  echo '
                  <tr>
                      <td align=center> <a href="politics.php?page='.$page.'">' .$page. '</a>  ';
                  echo '
                  </td>
                  </tr>';
                }
