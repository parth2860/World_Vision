    ...
    <div class="container-scroller">
      <header id="header">
        <div class="container">
          ...
          <img  src="../assets/images/travel/travel_2.jpg" height="200"  width="1100"  >
          ...
          <?php 
           $sql = "SELECT * FROM `post` WHERE `category` = 'global' AND `status` = 1 and `image` NOT LIKE '%mp4' order by id DESC  limit 4";
         ...
         <!--grid end -->
                  ...
                  $results_per_page = 5;
                  $result = mysqli_query($con,"SELECT * FROM `post` WHERE `category` = 'global' AND `status` = 1 and `image` NOT LIKE '%mp4' order by id DESC ");
                  ...
                  if($result->num_rows > 0){
                    ...
                    $re = mysqli_query($con ,"SELECT * FROM `post` WHERE `category` = 'global' AND `status` = 1 and `image` NOT LIKE '%mp4' order by id DESC LIMIT $this_page_first_result,$results_per_page ");
              ...
              ';
                ...
                for($page=1;$page<=$number_of_pages;$page++){
                  echo '
                  <tr>
                      <td align=center> <a href="world.php?page='.$page.'">' .$page. '</a>  ';
                  echo '
                  </td>
                  </tr>';
                }
