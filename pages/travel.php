              ...
              <div class="navbar-bottom-menu">
                ...
                >
                  ...
                  >
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="./author.php">Magazine</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="./news-post.php">Blog</a>
                    </li>
                    <li class="nav-item">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_1.jpg"
                class="img-fluid"
                alt="world-news"
              />
          ...
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="row">
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img
                    src="../assets/images/travel/Travel_4.jpg"
                    class="img-fluid"
                    alt="world-news"
                  />
                  <span class="thumb-title">TRAVEL</span>
              ...
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img
                    src="../assets/images/travel/Travel_2.jpg"
                    class="img-fluid"
                    alt="world-news"
                  />
                  <span class="thumb-title">TRAVEL</span>
            ...
            <div class="row mt-3">
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img
                    src="../assets/images/travel/Travel_5.jpg"
                    class="img-fluid"
                    alt="world-news"
                  />
                  <span class="thumb-title">TRAVEL</span>
              ...
              <div class="col-sm-6">
                <div class="position-relative image-hover">
                  <img
                    src="../assets/images/travel/Travel_3.jpg"
                    class="img-fluid"
                    alt="world-news"
                  />
                  <span class="thumb-title">TRAVEL</span>
        ...
        <div class="row mb-4">
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_6.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_10.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_14.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_16.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
        ...
        <div class="row mb-4">
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_8.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_12.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_18.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_20.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
        ...
        <div class="row mb-4">
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_7.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_11.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_15.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_17.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
        ...
        <div class="row">
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_9.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_13.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_19.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
          ...
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="../assets/images/travel/Travel_21.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
            ...
            <div class="row">
              ...
              <div class="col-sm-3 col-lg-3">
                <ul class="footer-vertical-nav">
                  <li class="menu-title"><a href="./news-post.php">News</a></li>
              ...
              <div class="col-sm-3 col-lg-3">
                <ul class="footer-vertical-nav">
                  ...
                  <li><a href="./news-post.php">Newsletters</a></li>
