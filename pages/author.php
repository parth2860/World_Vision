  ...
  <body>
    <div class="container-scroller">
     ...
     <div    id="WORLD Post" class="tabcontent" >
          <img  src="../assets/images/real-estate/Realestate_2.jpg" height="200"  width="1100"  >
          ...
          <?php 
           $sql = "SELECT * FROM `post` WHERE `category` = 'local' AND `status` = 1  and `image` NOT LIKE '%mp4' order by id DESC  limit 4";
         ...
         <!--grid end --> 
                    <?php
                    $results_per_page = 5;
                    $result = mysqli_query($con,"SELECT * FROM `post` WHERE `category` = 'local' AND `status` = 1 and `image` NOT LIKE '%mp4'  order by id DESC ");
                  ...
                  if($r3->num_rows > 0){
                     ...
                     $re = mysqli_query($con ,"SELECT * FROM `post` WHERE `category` = 'local' AND `status` = 1 and `image` NOT LIKE '%mp4'  order by id DESC LIMIT $this_page_first_result,$results_per_page ");
              ...
              ';
                ...
                for($page=1;$page<=$number_of_pages;$page++){
                  echo '
                  <tr>
                      <td align=center> <a href="author.php?page='.$page.'">' .$page. '</a>  ';
                  echo '
                  </td>
                  </tr>';
                }
