        ...
        <div class="container">
          ...
          <div    id="WORLD Post" class="tabcontent" >
                    ...
                    <?php
                       ...
                       $a=$_GET['id'];
                      $usql = "SELECT * FROM `post` WHERE `id` = '$a' and `image` not LIKE '%mp4' ";
  
                 
                  $r3 = $con->query($usql);
                  if($r3->num_rows > 0){
                    while($row = $r3->fetch_assoc())
                    /*$result = mysqli_query($db, "SELECT * FROM `post` WHERE `category` = 'global' AND `status` = 1 order by id DESC  ");
...
$a=$_GET['id'];
$usql = "SELECT * FROM `group1` WHERE `id` = '$a' and `image` not LIKE '%mp4' ";
...
<div class="d-flex justify-content-between align-items-center">
 ...
 </div>   <h2><div align="center" >'.$row['name'].'</div></h2>
<div>
<div class="dropdown">
 '.$row['gname'].'
     <button class="btn btn-link dropdown-toggle" type="button" id="gedf-drop2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<tr ">
<td >   <img src="../admin/post/'.$row['image'].' " width=500 height=300 > </td>
<td align="center" width=600 height=300> '.$row['text'].'</td>
</tr>
</table>
...
?>
                  <!--page e -->
                   ...
                   <?php
                      ...
                      $a=$_GET['id'];
                      $usql = "SELECT * FROM `post` WHERE `id` = '$a' and `image`  LIKE '%mp4' ";
                      ...
                      <table  align="justify">
                      <tr ">
                      <td align="center">  <video  width=800 height=400 controls> <source src="../admin/post/'.$row['image'].' "  > </video></td>

                      </tr>
                      <tr> <td align="center" width=600 height=80> '.$row['content'].'</td></tr>
                      </table>
...
$a=$_GET['id'];
$usql = "SELECT * FROM `group1` WHERE `id` = '$a' and `image`  LIKE '%mp4' ";
...
<tr> <td align="center" width=600 height=80> '.$row['text'].'</td></tr>
</table>
