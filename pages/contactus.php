<?php
  ...
  $sql="INSERT INTO `contactus`( `username`,  `email`, `subject`, `msg`)VALUES ('$name','$email','$subject','$message')";
          ...
          <div class="col-sm-12">
            <div class="text-center">
              ...
              <p class="text-secondary fs-15 mb-5 pb-3">
                in any case you are having trouble with our services feel free to inform us.we will try to look after 
              </p>
            </div>
          </div>
        </div>
